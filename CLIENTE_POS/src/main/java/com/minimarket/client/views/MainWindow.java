...
public class MainWindow extends JFrame {
    ...
    private final SucursalService sucursalSvc = new SucursalService();
    ...
    public MainWindow() {
        ...
        addView("ventas",    new VentasView(ventaSvc, productoSvc, clienteSvc, sucursalSvc));
    ...
    private JPanel sidebarHeader() {
        ...
        JLabel sub = new JLabel("Sistema POS - Thin Client");
